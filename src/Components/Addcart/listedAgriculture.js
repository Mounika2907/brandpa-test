...
export const Listedagriculture =(props) => {
  const {  src, type, price,name } = props.items;
...
<div className="card" style ={{  width: "270px", display: "inline-block",  height:"250px",   marginTop: "20px",     marginLeft: "15px"
 , marginRight:"59px", margin:"25px"}}>
  ...
  fontFamily:" 'Helvetica Neue',Helvetica,Arial,sans-serif; ", color:"black",wordSpacing: "1cm"}}>{name}</p>
        </div>
  ...
  fontFamily:" 'Helvetica Neue',Helvetica,Arial,sans-serif; ", color:"black",    left: "188px",}}>${price}</p>
