...
const Navigationbar = () => {
  return (
    ...
    <nav className="navbar navbar-expand-lg" style ={{top: "0px",height:"100px", background: "white" ,position:"fixed"}}>
          ...
          <ul className="navbar-nav ml-auto" style ={{color:"white"}}>
            ...
            <li className="nav-item dropdown">
              <a
                ...
                style ={{color:"black"}}
              >
                <Link to="/addcart">By industry</Link>
